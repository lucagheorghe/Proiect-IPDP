  ...
  <section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="images/logo.png" class="m-r-sm">Notitse</a>
      ...
      <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu animated fadeInRight">
            ...
            <li class="divider"></li>
            <li>
              <a href="logout.php" data-toggle="ajaxModal">Delogare</a>
            </li>
          </ul>
        </li>
      </ul>
        ...
        <section id="content">
          <section class="hbox stretch">
            <aside class="aside-lg bg-light lter b-r">
              <div class="wrapper">
                <h4 class="m-t-none">Adaugă notiță</h4>
                <form method="POST">
                  <?php
                  ...
                  <div class="form-group">
                    <label>Notiță</label>
                    <textarea name="note" class="form-control" rows="8" data-minwords="8" data-required="true" placeholder="Scrie ceva..."><?php echo $row['note']; ?></textarea>
                  </div>
                  <div class="m-t-lg"><button class="btn btn-sm btn-default" name="update" type="submit">Actualizare notiță</button></div>
                </form>
              </div>
            </aside>
                ...
                <header class="header bg-light bg-gradient">
                  <ul class="nav nav-tabs nav-white">
                    <li class="active"><a href="#activity" data-toggle="tab">
                        <h4 style="text-transform:uppercase;"><b>Detalii despre notițe</b></h4>
                      </a></li>
                  </ul>
                </header>
