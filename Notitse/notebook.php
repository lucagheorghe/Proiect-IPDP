            ...
            <aside class="aside-lg bg-light lter b-r">
              <div class="wrapper">
                ...
                <form method="POST">
                  ...
                  <div class="form-group">
                    <label>Notiță</label>
                    <textarea name="note" class="form-control" rows="8" data-minwords="8" data-required="true" placeholder="Scrie ceva..."></textarea>
                  </div>
                  <div class="m-t-lg"><button class="btn btn-sm btn-default" name="submit" type="submit">Adaugă</button></div>
                </form>
              </div>
            </aside>
